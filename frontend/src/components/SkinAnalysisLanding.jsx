  ...
  return (
    ...
    >
      <div className="text-center text-white z-10">
        ...
        <button
          className="mt-12 px-16 py-6 border-2 border-white rounded-full font-lato text-xl font-light hover:bg-white hover:bg-opacity-80  transition-all duration-300"
